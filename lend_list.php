		...
		<div id=inside_body_title >
			...
			<div id=search_results>
				...
				<tr height="80px">
					...
					<td width="35%">Πρόθεσμία: Λήγει σε 3 μέρες						
						</br><a href="./">Ενημέρωση ημερομηνίας παράδοσης>></a>
						</br><a href="./">Ανανέωση δανεισμού++</a>
					</td>
				</tr>
				<tr height="80px">
					<td width="65%">2.</br>	
					...
					<td width="35%">Πρόθεσμία: Λήγει σε 5 μέρες						
						</br><a href="./">Ενημέρωση ημερομηνίας παράδοσης>></a>
						</br><a href="./">Ανανέωση δανεισμού++</a>
					</td>
				</tr>
				...
				<tr height="80px">
					...
					<td width="35%">Πρόθεσμία: Έχει λήξει πριν 2 μέρες!				
						</br><a href="./">Ενημέρωση ημερομηνίας παράδοσης>></a>
						</br><a href="./">Ανανέωση δανεισμού++</a>
					</td>
				</tr>
