...
<!-- INSIDE BODY -->
		...
		Επιλέξτε κατηγορία απο το μενού στα αρίστερά
		</div>
		...
		<div style="text-align:left; margin-left: 50px; border-left: groove;">
			>Κατηγορία:	
			<select name="mySelect">
		...
		<div style="text-align:left; margin-left: 50px; border-left: groove;">	
			...
			<select name="mySelect">
		    		...
		    		<option value="1">Έτος Έκδοσης</option>
		    		<option value="2">Αλφαβητική</option>
			...
			<div id=search_results>
				...
				<tr height="80px">
					<td width="75%">1.</br>
						ΟΙ ΜΟΡΦΕΣ ΕΛΕΥΘΕΡΟΥ ΚΡΑΤΟΥΣ ΠΟΥ ΟΡΑΜΑΤΙΖΟΝΤΑΝ ΟΙ ΑΓΩΝΙΣΤΕΣ ΤΟΥ 21 
						ΠΑΠΑΝΤΩΝΙΟΥ ΝΙΚΟΣ
						</br>ΝΕΦΕΛΗ 1988	
					</td>	
					<td width="25%">Κατάσταση: Μη Διαθέσιμο						
				...
				<tr height="80px">
					<td width="75%">2.</br>	
						Η ΔΥΤΙΚΗ ΘΡΑΚΗ ΣΤΗΝ ΕΞΩΤΕΡΙΚΗ ΠΟΛΙΤΙΚΗ ΤΗΣ ΒΟΥΛΓΑΡΙΑΣ
						</br>
						ΣΤΑΥΡΙΝΟΥ ΠΑΞΙΜΑΔΟΠΟΥΛΟΥ ΜΙΡΑΝΤΑ
						</br>GUTENBERG 1997
				...
				<tr height="80px">
					<td width="75%">
						4.	</br>
						ΣΥΝΕΡΓΑΤΕΣ ΤΩΝ ΝΑΖΙ ΣΤΗΝ ΕΥΡΩΠΗ 
						</br>ΧΟΝΔΡΟΜΑΤΙΔΗΣ ΙΑΚΩΒΟΣ
						</br>ΠΕΡΙΣΚΟΠΙΟ  2009 
					</td>	
					<td width="25%">Κατάσταση: Διαθέσιμο						
						</br><a href="./">Δανεισμός>></a>
				...
				<tr height="80px">
					<td width="75%">
						...
						</br>ΔΕΛΗΓΙΑΝΝΗΣ ΠΕΡΙΚΛΗΣ, ΓΙΑΝΝΟΠΟΥΛΟΣ ΝΙΚΟΛΑΟΣ)
						</br>ΠΕΡΙΣΚΟΠΙΟ  2010  
					</td>	
					<td width="25%">Κατάσταση: Διαθέσιμο						
						</br><a href="./">Δανεισμός>></a>
