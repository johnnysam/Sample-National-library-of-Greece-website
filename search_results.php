...
<!-- INSIDE BODY -->
		<div id=inside_body_title >
			Εμφάνιση αποτελεσμάτων για:	Καζαντζάκης
		</div>
		...
		<div style="text-align:center">
			...
			αποτελεσμάτων ανά σελίδα
		</div>
			<div id=search_results>
				<table width=“90%” align=”left” cellpadding="12" cellspacing="20"
				border="1">
				<tr height="80px">
					<td width="75%">1.</br>
						Ὁ κριτικός Ν. Καζαντζάκης / ὑπό Μαν. Γιαλουράκη 
						by Γιαλουράκης , Μανώλης (1921-1987)
						</br>[Ἀθήνα] : Δίοδος [1971]	
					</td>	
					<td width="25%">Κατάσταση: Διαθέσιμο						
						</br><a href="./">Δανεισμός>></a>
						</br><a href="./">Προσθήκη στη λίστα μου++</a>
					</td>
				</tr>
				<tr height="80px">
					<td width="75%">2.</br>	
						Κάρμα Νιρβαμῆ : Ὄφις καί κρῖνο 
						by Καζαντζάκης , Νίκος (1883-1957)
						</br>Ἀθήνα : [χ.ἐ.] 1906	
					</td>	
					<td width="25%">Κατάσταση: Διαθέσιμο						
						</br><a href="./">Δανεισμός>></a>
				...
				<tr height="80px">
					<td width="75%">
						3.</br>	
						Η θεωρία της συγκινήσεως / μετάφρασις Ν. Καζαντζάκη 
						by James , William (1842-1910), Καζαντζάκης , Νίκος (1883-1957)
						</br>Εν Αθήναις : Γ. Φέξης 1911
					</td>	
					<td width="25%">Κατάσταση: Διαθέσιμο						
						</br><a href="./">Δανεισμός>></a>
						</br><a href="./">Προσθήκη στη λίστα μου++</a>
				...
				<tr height="80px">
					<td width="75%">
						4.	</br>
						Πλάτωνος Δημόδοκος, Σίσυφος, Κλειτοφῶν, Ἴων, Μίνως / μετάφρασις Ν. 							Καζαντζάκης 
						by Πλάτων (427-347), Καζαντζάκης , Νίκος (1883-1957)
						</br>Ἐν Ἀθηναις : Φέξης 1912
					</td>	
					<td width="25%">Κατάσταση: Διαθέσιμο						
						</br><a href="./">Δανεισμός>></a>
						</br><a href="./">Προσθήκη στη λίστα μου++</a>
			...
			<div style="float:right; margin-top:1cm; " >
				Σελίδες <a href="./">1</a>,<a href="./">2</a>,<a href="./">3</a>
				,...,<a href="./">20</a>
			</div>
